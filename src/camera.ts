...
class Camera extends Element {
    ...
    viewFront() { this.animateToView(0, 0); }
    viewBack() { this.animateToView(180, 0); }
    viewLeft() { this.animateToView(90, 0); }
    viewRight() { this.animateToView(-90, 0); }
    viewTop() { this.animateToView(this.azim, 89); }
    viewBottom() { this.animateToView(this.azim, -89); }
